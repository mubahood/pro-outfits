            ...
            <div class="swiper-wrapper">
                ...
                <div class="swiper-slide py-3">
                    <a href="#" class="card card-body card-hover px-2 mx-2">
                        <img src="assets/images/pro_outfits.png" class="d-block mx-auto my-2" width="154" alt="Brand">
                    </a>
                </div>
                ...
                <div class="swiper-slide py-3">
                    <a href="#" class="card card-body card-hover px-2 mx-2">
                        <img src="assets/images/Pro-Outfits.png" class="d-block mx-auto my-2" width="154" alt="Brand">
                    </a>
                </div>
            ...
            <div class="row pb-5">
                <div class="col-lg-4 col-md-6">
                    <div class="navbar-brand text-dark p-0 me-0 mb-3 mb-lg-4">
                        <img src="assets/img/logo-1.png" width="260" alt="PRO-OUTFITS">
                    </div>
                        ...
                        <div class="col-xl-4 col-lg-5 pt-2 pt-lg-0">
                            ...
                            <ul class="nav flex-column mb-2 mb-lg-0">
                                ...
                                <li class="nav-item"><a href="https://www.oic-oci.org/" target="_blank"
                                        class="nav-link d-inline-block px-0 pt-1 pb-2">PRO-OUTFITS</a></li>

                                <li class="nav-item"><a href="https://pro-outfits.net" target="_blank"
                                        class="nav-link d-inline-block px-0 pt-1 pb-2">pro-outfits Consultants</a></li>
                            </ul>
                            <a href="mailto:info@PRO-OUTFITS.org" class="fw-medium">info@ict4personswithdisabilities.org</a>
                        </div>
                    </div>
                </div>
            </div>
